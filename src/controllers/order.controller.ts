...
// export const updateDashboardOrderHandler = async (
//   req: Request,
//   res: Response
// ) => {
//   try {
...
//     });
//   } catch (err: any) {
//     return responseErrors(res, 400, "Can't update your Order", err.message);
//   }
// };
...
//     await orderRepository.softDelete(Order.id); //FIXME
...
//     });
//   } catch (err: any) {
//     return responseErrors(res, 400, "Can't delete your Order", err.message);
//   }
// };
